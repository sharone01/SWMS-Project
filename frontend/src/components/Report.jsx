...
function Report() {
  ...
  return (
    <form
      ...
      className="p-6 max-w-lg mx-auto shadow-md rounded-lg"
    >
      <h2 className="text-2xl font-bold mb-4 text-center">Report Waste</h2>
      <label>Waste Type</label>
      <br />
      <select
        className="w-full  border mb-3 cols-100 p-3 rounded-3 form-control"
        onChange={(e) =>
      ...
      <br />
      <textarea
        className="border mb-3 cols-100 p-3 rounded-3 form-control"
        onChange={(e) =>
