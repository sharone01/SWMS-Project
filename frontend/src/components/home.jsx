...
const Home = () => {
  ...
  return (
    <>
      ...
      <section
        className="hero-sub container-fluid"
        style={{
          display: "flex",
      ...
      <section className="projects">
        ...
        <div className="main-projects" style={{ marginTop: "5rem" }}>
          ...
          <h1>
            Recently We Successfully Completed <br /> Some Waste Projects
          </h1>
        </div>
      ...
      <section className="feedbacks cols-12">
        <div className="left cols-6">
          ...
          <h2>
            ...
            Are Talking ABout <br /> Our Services
          </h2>

          <div>
            <p>
              Proin a lacus arcu. Nullam id dui eu orci <br />
              maximus. Cras at auctor lectus, pretium tellus.
            </p>
        ...
        <div className="feedback-slide ">
          ...
          <div>
            <p>
              {" "}
              Proin a lacus arcu. Nullam id dui eu orci maximus. Cras at <br />
              auctor lectus, pretium tellus quis nostrud exercitation ullamco
              laboris{" "}
            </p>

            <div className="d-flex">
              <div className="circle-testimonial ">
                <img src={testimonial1} className="rounded-5" alt="..." />
              </div>
              <div>
      ...
      <footer>
        ...
        <div className="footer-bottom">
          <div className="bottom-first">
            ...
            <p>
              Lorem ipsum dolor sited ame etur adi <br />
            ...
            <input
              ...
              className="cols-200 p-3 rounded-3"
            />
          </div>
          <div className="bottom-center">
            ...
            <ul>
              <li>
                <Link>Dumpster Rentals</Link>
              </li>

              <li>
                <Link>Bulk Trash pickup</Link>
              </li>
              <li>
                <Link>Waste Removal</Link>
              </li>
            </ul>
          </div>
